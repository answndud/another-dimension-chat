...
- Redacted status separates release-claim, messaging-surface, profile, pairing, transport, storage, and verification boundaries without exposing profile/contact/endpoint data.
