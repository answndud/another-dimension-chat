...
- Redacted status separates release-claim, messaging-surface, profile, pairing, transport, and storage boundaries without exposing profile/contact/endpoint data.
