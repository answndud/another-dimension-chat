...
export function productionWindowsPublicArtifactCandidateView(input = {}) {
  ...
  return {
    ...
    engineSidecarPackagedRequired: true,
    engineSidecarContractVersion: 1,
    engineSidecarProtocol: "ad-engine-json-stdio-v1",
    engineSidecarStatusCommand: "status",
    engineSidecarManualSelfTestCommand: "manual-self-test",
    engineSidecarManualSelfTestRequired: true,
    engineSidecarSpawnSupported: true,
    engineSidecarRawPathReturned: false,
