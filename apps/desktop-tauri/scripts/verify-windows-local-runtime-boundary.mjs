...
requireText("apps/desktop-tauri/package.json", "node scripts/prepare-engine-sidecar.mjs --release --manual-e2ee-runtime --tauri-build -- tauri build --config src-tauri/tauri.sidecar.conf.json --features public-shell --bundles nsis -- --no-default-features");
...
requireText("apps/desktop-tauri/scripts/prepare-engine-sidecar.mjs", "manual-e2ee-runtime");
...
requireText("apps/engine/Cargo.toml", "manual-e2ee-runtime = [");
requireText("apps/engine/Cargo.toml", "full-runtime = [");
requireText("apps/engine/Cargo.toml", "dep:another-dimension-core");
...
requireText("apps/engine/src/main.rs", "manual-self-test");
requireText("apps/engine/src/main.rs", "ad-engine-manual-e2ee-self-test-v1");
requireText("apps/engine/src/main.rs", "cfg!(feature = \"full-runtime\")");
requireText("apps/engine/src/main.rs", "cfg!(feature = \"manual-e2ee-runtime\")");
...
requireText("apps/engine/src/main.rs", "plaintext_returned: false");
requireText("apps/engine/src/main.rs", "ciphertext_returned: false");
requireText("apps/engine/src/main.rs", "invite_code_returned: false");
requireText("apps/engine/src/main.rs", "endpoint_returned: false");
...
requireText("apps/desktop-tauri/src-tauri/src/main.rs", "engine_sidecar_status");
requireText("apps/desktop-tauri/src-tauri/src/main.rs", "engine_sidecar_manual_self_test");
requireText("apps/desktop-tauri/src-tauri/src/main.rs", "sidecar_path_returned: false");
requireText("apps/desktop-tauri/src-tauri/src/main.rs", "stdout_returned: false");
requireText("apps/desktop-tauri/src-tauri/src/main.rs", "stderr_returned: false");
requireText("apps/desktop-tauri/src-tauri/src/main.rs", "sidecar-command-failed");
requireText("apps/desktop-tauri/src-tauri/src/main.rs", "manual-e2ee-runtime-not-compiled");
requireText("apps/desktop-tauri/src/action-state.js", "engine_sidecar_spawn_supported=true");
requireText("apps/desktop-tauri/src/action-state.js", "engine_sidecar_stdout_returned=false");
requireText("apps/desktop-tauri/src/action-state.js", "engine_sidecar_stderr_returned=false");
