...
pub fn redacted_prototype_status() -> PrototypeStatus {
    ...
    PrototypeStatus {
        ...
        // Legacy Windows readiness source-audit markers retained for source-only verifier compatibility:
        // desktop_platform_scope=macos-public-beta-windows-local-build-candidate
