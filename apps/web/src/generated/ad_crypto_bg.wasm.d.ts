...
export const olm_session_decrypt: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const olm_session_encrypt: (a: number, b: number, c: number, d: number, e: number) => void;
export const safety_material: (a: number, b: number, c: number) => void;
