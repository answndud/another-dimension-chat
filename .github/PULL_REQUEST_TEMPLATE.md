...
This project is not a secure messenger release today.
...
- [ ] Public text preserves `unsigned experimental public beta`, `not audited`,
...
- [ ] Public files do not include bridge lines, onion endpoints, invite codes,
      ...
      private room data.
- [ ] If release files changed, `scripts/prepare_unsigned_public_beta_release.sh`
      still generates the complete upload set.
