...
- A release signing implementation plan in [RELEASE_SIGNING_PLAN.md](RELEASE_SIGNING_PLAN.md), tooling decision in [RELEASE_SIGNING_TOOLING_DECISION.md](RELEASE_SIGNING_TOOLING_DECISION.md), ceremony dry-run record in [RELEASE_SIGNING_CEREMONY_DRY_RUN.md](RELEASE_SIGNING_CEREMONY_DRY_RUN.md), real key ceremony requirements in [RELEASE_KEY_CEREMONY_REQUIREMENTS.md](RELEASE_KEY_CEREMONY_REQUIREMENTS.md), artifact signing requirements in [RELEASE_ARTIFACT_SIGNING_REQUIREMENTS.md](RELEASE_ARTIFACT_SIGNING_REQUIREMENTS.md), verification UX requirements in [RELEASE_VERIFICATION_UX_REQUIREMENTS.md](RELEASE_VERIFICATION_UX_REQUIREMENTS.md), candidate evidence index in [RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX.md), candidate evidence collection runbook in [RELEASE_SIGNING_CANDIDATE_EVIDENCE_RUNBOOK.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_RUNBOOK.md), candidate evidence fixture in [RELEASE_SIGNING_CANDIDATE_EVIDENCE_FIXTURE.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_FIXTURE.md), candidate evidence fixture coverage audit in [RELEASE_SIGNING_CANDIDATE_EVIDENCE_FIXTURE_AUDIT.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_FIXTURE_AUDIT.md), release-note non-claim guard in [RELEASE_SIGNING_RELEASE_NOTE_NON_CLAIM_GUARD.md](RELEASE_SIGNING_RELEASE_NOTE_NON_CLAIM_GUARD.md), evidence package layout fixture in [RELEASE_SIGNING_EVIDENCE_PACKAGE_LAYOUT_FIXTURE.md](RELEASE_SIGNING_EVIDENCE_PACKAGE_LAYOUT_FIXTURE.md), evidence package layout coverage audit in [RELEASE_SIGNING_EVIDENCE_PACKAGE_LAYOUT_AUDIT.md](RELEASE_SIGNING_EVIDENCE_PACKAGE_LAYOUT_AUDIT.md), candidate manifest consistency fixture in [RELEASE_SIGNING_CANDIDATE_MANIFEST_CONSISTENCY_FIXTURE.md](RELEASE_SIGNING_CANDIDATE_MANIFEST_CONSISTENCY_FIXTURE.md), candidate manifest consistency coverage audit in [RELEASE_SIGNING_CANDIDATE_MANIFEST_CONSISTENCY_AUDIT.md](RELEASE_SIGNING_CANDIDATE_MANIFEST_CONSISTENCY_AUDIT.md), candidate evidence package checksum coverage audit in [RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_AUDIT.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_AUDIT.md), candidate evidence package checksum non-claim guard in [RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_NON_CLAIM_GUARD.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_NON_CLAIM_GUARD.md), candidate evidence package checksum guard coverage audit in [RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_GUARD_AUDIT.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_GUARD_AUDIT.md), candidate evidence index checksum binding requirements in [RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_REQUIREMENTS.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_REQUIREMENTS.md), candidate evidence index checksum binding fixture in [RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_FIXTURE.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_FIXTURE.md), candidate evidence index checksum fixture coverage audit in [RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_FIXTURE_AUDIT.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_FIXTURE_AUDIT.md), candidate signed-artifact verification requirements in [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_REQUIREMENTS.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_REQUIREMENTS.md), candidate signed-artifact verification fixture in [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_FIXTURE.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_FIXTURE.md), candidate signed-artifact verification fixture coverage audit in [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_FIXTURE_AUDIT.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_FIXTURE_AUDIT.md), signed-artifact verification non-claim guard in [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_NON_CLAIM_GUARD.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_NON_CLAIM_GUARD.md), signed-artifact verification guard coverage audit in [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_GUARD_AUDIT.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_GUARD_AUDIT.md), signed-artifact verification guard audit coverage checks in [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_GUARD_AUDIT_COVERAGE_CHECKS.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_GUARD_AUDIT_COVERAGE_CHECKS.md), signed-artifact verification record template in [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_RECORD_TEMPLATE.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_RECORD_TEMPLATE.md), signed-artifact verification record template coverage audit in [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_RECORD_TEMPLATE_COVERAGE_AUDIT.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_RECORD_TEMPLATE_COVERAGE_AUDIT.md), ceremony command harness in `scripts/verify_release_signing_ceremony_harness.sh`, dry-run verifier in `scripts/verify_release_signing_dry_run.sh`, and disposable detached-signature fixture in `scripts/verify_release_detached_signature_fixture.sh` that record the intended offline detached-signature path without claiming signing readiness.
...
| --- | --- | --- |
| Release signing | No release signing workflow or signed artifact verification exists; a pre-implementation signing plan, tooling decision, ceremony dry-run record, real key ceremony requirements, artifact signing requirements, Release verification UX evidence requirements, candidate evidence index, candidate evidence collection runbook, candidate evidence fixture, candidate evidence fixture coverage audit, release-note non-claim guard, evidence package layout fixture, evidence package layout coverage audit, candidate manifest consistency fixture, candidate manifest consistency coverage audit, candidate evidence package checksum coverage audit, candidate evidence package checksum non-claim guard, candidate evidence package checksum guard coverage audit, candidate evidence index checksum binding requirements, candidate evidence index checksum binding fixture, candidate evidence index checksum fixture coverage audit, candidate signed-artifact verification requirements, candidate signed-artifact verification fixture, candidate signed-artifact verification fixture coverage audit, signed-artifact verification non-claim guard, signed-artifact verification guard coverage audit, signed-artifact verification guard audit coverage checks, signed-artifact verification record template, signed-artifact verification record template coverage audit, ceremony command harness, dry-run verifier, and disposable detached-signature fixture exist. | Add platform signing, verification instructions, and a checked release process. |
...
`scripts/verify_release_signing_candidate_manifest_consistency_fixture.sh` checks disposable candidate evidence manifest consistency behavior. It rejects missing or empty artifact manifests, stale index manifest digests, mismatched record commit, mismatched record tag, mismatched record manifest digest, template-only evidence, and placeholder evidence, but it does not collect release evidence or approve release signing.

`scripts/verify_release_signing_candidate_manifest_consistency_audit.sh` checks that [RELEASE_SIGNING_CANDIDATE_MANIFEST_CONSISTENCY_AUDIT.md](RELEASE_SIGNING_CANDIDATE_MANIFEST_CONSISTENCY_AUDIT.md) records the manifest consistency fixture coverage and limits without treating manifest consistency coverage as release evidence or release approval.

`scripts/verify_release_signing_candidate_evidence_package_checksum_audit.sh` checks that [RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_AUDIT.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_AUDIT.md) records fixture checksum and digest coverage without treating checksum coverage as release evidence or release approval.

`scripts/verify_release_signing_candidate_evidence_package_checksum_non_claim_guard.sh` checks that [RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_NON_CLAIM_GUARD.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_NON_CLAIM_GUARD.md) blocks checksum fixture coverage from implying release evidence, signed artifact verification, artifact authenticity, or release approval.

`scripts/verify_release_signing_candidate_evidence_package_checksum_guard_audit.sh` checks that [RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_GUARD_AUDIT.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_PACKAGE_CHECKSUM_GUARD_AUDIT.md) records checksum non-claim guard coverage and limits without treating guard coverage as release evidence or release approval.

`scripts/verify_release_signing_candidate_evidence_index_checksum_requirements.sh` checks that [RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_REQUIREMENTS.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_REQUIREMENTS.md) defines future index and record checksum binding requirements without collecting candidate evidence or approving release signing.

`scripts/verify_release_signing_candidate_evidence_index_checksum_fixture.sh` checks that [RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_FIXTURE.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_FIXTURE.md) rejects missing, stale, mismatched, template-only, placeholder, and empty-blocker disposable index checksum fixture states without collecting candidate evidence or approving release signing.

`scripts/verify_release_signing_candidate_evidence_index_checksum_fixture_audit.sh` checks that [RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_FIXTURE_AUDIT.md](RELEASE_SIGNING_CANDIDATE_EVIDENCE_INDEX_CHECKSUM_FIXTURE_AUDIT.md) records index checksum fixture coverage and limits without treating fixture coverage as candidate evidence or release approval.

`scripts/verify_release_signing_candidate_signed_artifact_verification_requirements.sh` checks that [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_REQUIREMENTS.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_REQUIREMENTS.md) defines future candidate signed-artifact verification record requirements without collecting candidate evidence, verifying detached signatures, or approving release signing.

`scripts/verify_release_signing_candidate_signed_artifact_verification_fixture.sh` checks that [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_FIXTURE.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_FIXTURE.md) rejects missing, stale, mismatched, template-only, placeholder, and empty-blocker disposable signed-artifact verification fixture states without verifying detached signatures or approving release signing.

`scripts/verify_release_signing_candidate_signed_artifact_verification_fixture_audit.sh` checks that [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_FIXTURE_AUDIT.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_FIXTURE_AUDIT.md) records signed-artifact verification fixture coverage and limits without treating fixture coverage as signed artifact verification evidence or release approval.

`scripts/verify_release_signing_candidate_signed_artifact_verification_non_claim_guard.sh` checks that [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_NON_CLAIM_GUARD.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_NON_CLAIM_GUARD.md) blocks fixture signed-artifact verification coverage from implying signed artifact verification evidence, detached signature verification evidence, artifact authenticity, or release approval.

`scripts/verify_release_signing_candidate_signed_artifact_verification_guard_audit.sh` checks that [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_GUARD_AUDIT.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_GUARD_AUDIT.md) records signed-artifact verification non-claim guard coverage and limits without treating guard coverage as signed artifact verification evidence or release approval.

`scripts/verify_release_signing_candidate_signed_artifact_verification_guard_audit_coverage_checks.sh` checks that [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_GUARD_AUDIT_COVERAGE_CHECKS.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_GUARD_AUDIT_COVERAGE_CHECKS.md) keeps guard audit coverage checks synchronized with the guard audit and non-claim guard without treating coverage checks as signed artifact verification evidence or release approval.

`scripts/verify_release_signing_candidate_signed_artifact_verification_record_template.sh` checks that [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_RECORD_TEMPLATE.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_RECORD_TEMPLATE.md) remains a template with placeholders and `not-signed-artifact-verification-evidence` classification. It does not verify detached signatures, prove artifact authenticity, or approve release signing.

`scripts/verify_release_signing_candidate_signed_artifact_verification_record_template_coverage_audit.sh` checks that [RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_RECORD_TEMPLATE_COVERAGE_AUDIT.md](RELEASE_SIGNING_CANDIDATE_SIGNED_ARTIFACT_VERIFICATION_RECORD_TEMPLATE_COVERAGE_AUDIT.md) records coverage expectations for the record template while remaining audit-only. It does not verify detached signatures, prove artifact authenticity, or approve release signing.
