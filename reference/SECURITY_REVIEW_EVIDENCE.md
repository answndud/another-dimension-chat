...
| storage/backup/wipe | `apps/web/src/web-runtime.js` | focused browser tests, quota-style storage failure, local acceptance | passphrase-wrapped backup, quota-style fail-closed lock, and fail-closed import evidence | secure deletion·actual quota/eviction/private-mode matrix는 non-claim 또는 미검증 |
