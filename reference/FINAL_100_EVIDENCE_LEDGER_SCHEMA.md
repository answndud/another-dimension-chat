...
set. External review signoff and audit finding tracker child files must pass
...
`AD_REQUIRE_CURRENT_HEAD=1` when the evidence bundle must match the checked-out
commit.
