...
- `crates/transport/src/lib.rs`: crate top-level intent
- `crates/transport/src/lib.rs`: runtime preflight exports
- `crates/transport/src/lib.rs`: transport policy exports
- `apps/desktop-tauri/src-tauri/src/lib.rs`: desktop platform boundary summary
- `apps/desktop-tauri/src/main.js`: manual network permission, default transport UI copy

관련 public reference:

- `reference/PRODUCTION_DEFAULT_TRANSPORT_PATH.md`
- `reference/PRODUCTION_DEFAULT_PRACTICAL_TRANSPORT_CLAIM.md`
- `reference/TRANSPORT_DECISION.md`
