...
아래는 중앙 server가 message content를 읽지 못하는 상황에서도 알 수 있는 정보를 보여주는 설명용 예시다.

```text
content: FAKE_CIPHERTEXT_ONLY
server_can_see:
  sender_account: alice_123
  receiver_account: bob_456
  sent_at: 2026-06-13T10:00:00Z
  ciphertext_size: 2048 bytes
  delivery_status: delivered
  device_push_token: FAKE_PUSH_TOKEN
server_cannot_see_if_e2ee_works:
  plaintext: "meet at ..."
```

이 예시는 E2EE가 쓸모없다는 뜻이 아니다. E2EE는 message content 보호에 중요하다. 다만 central account, contact discovery, relay, push, backup이 있으면 content 밖의 metadata와 authority가 남을 수 있다는 뜻이다.
...
- [reference/PRIVACY_MODEL_COMPARISON.md](../PRIVACY_MODEL_COMPARISON.md)
