...
| Release and updates | No release signing, reproducible/equivalent build evidence, dependency review evidence, release-candidate signoff evidence, external review readiness evidence, or update/installer integrity evidence exists. Template-only release scaffold files and their verifiers have been removed from the active tree. | Add release work only for a real release candidate, using a small checklist or existing public copy instead of per-slice Markdown/verifier sprawl. |
