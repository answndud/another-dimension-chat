...
| --- | --- | --- |
| Release signing | [RELEASE_SIGNING_PLAN.md](RELEASE_SIGNING_PLAN.md), [RELEASE_SIGNING_TOOLING_DECISION.md](RELEASE_SIGNING_TOOLING_DECISION.md), dry-run fixture verifiers, detached-signature fixture, tooling gate | Missing real release key ceremony, signed artifacts, and signed artifact verification. |
