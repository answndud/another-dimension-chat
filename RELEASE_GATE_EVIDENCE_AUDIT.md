...
| --- | --- | --- |
| Release signing | [RELEASE_SIGNING_PLAN.md](RELEASE_SIGNING_PLAN.md), dry-run fixture verifiers, detached-signature fixture, tooling gate | Missing real release key ceremony, selected final tooling, signed artifacts, and signed artifact verification. |
