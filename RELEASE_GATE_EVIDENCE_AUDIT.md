...
| --- | --- | --- |
| Release signing | [RELEASE_SIGNING_PLAN.md](RELEASE_SIGNING_PLAN.md), [RELEASE_SIGNING_TOOLING_DECISION.md](RELEASE_SIGNING_TOOLING_DECISION.md), [RELEASE_SIGNING_CEREMONY_DRY_RUN.md](RELEASE_SIGNING_CEREMONY_DRY_RUN.md), ceremony command harness, dry-run fixture verifiers, detached-signature fixture, tooling gate | Missing real release key ceremony, signed artifacts, and signed artifact verification. |
