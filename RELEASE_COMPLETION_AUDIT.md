...
- `scripts/verify_release_signing_candidate_signed_artifact_verification_fixture_audit.sh`
- `scripts/verify_release_signing_candidate_signed_artifact_verification_non_claim_guard.sh`
- `scripts/verify_release_signing_candidate_signed_artifact_verification_guard_audit.sh`
- `scripts/verify_release_signing_candidate_signed_artifact_verification_guard_audit_coverage_checks.sh`
- `scripts/verify_release_signing_candidate_signed_artifact_verification_record_template.sh`
