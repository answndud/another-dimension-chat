...
- [RELEASE_HARDENING.md](RELEASE_HARDENING.md), [RELEASE_COMPLETION_AUDIT.md](RELEASE_COMPLETION_AUDIT.md), [RELEASE_SIGNING_PLAN.md](RELEASE_SIGNING_PLAN.md), and [RELEASE_BINARY_VERIFICATION_PLAN.md](RELEASE_BINARY_VERIFICATION_PLAN.md): track missing release signing implementation, reproducible/equivalent verification evidence, dependency review, release-candidate signoff, external review readiness, update/installer integrity, and the current not-complete audit verdict before any security-ready claim.
