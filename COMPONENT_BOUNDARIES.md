...
- [RELEASE_HARDENING.md](RELEASE_HARDENING.md), [RELEASE_COMPLETION_AUDIT.md](RELEASE_COMPLETION_AUDIT.md), [RELEASE_SIGNING_PLAN.md](RELEASE_SIGNING_PLAN.md), [RELEASE_BINARY_VERIFICATION_PLAN.md](RELEASE_BINARY_VERIFICATION_PLAN.md), [RELEASE_BINARY_INPUT_TEMPLATE.md](RELEASE_BINARY_INPUT_TEMPLATE.md), [RELEASE_DEPENDENCY_REVIEW_TEMPLATE.md](RELEASE_DEPENDENCY_REVIEW_TEMPLATE.md), and [RELEASE_EXTERNAL_REVIEW_TEMPLATE.md](RELEASE_EXTERNAL_REVIEW_TEMPLATE.md): track missing release signing implementation, reproducible/equivalent verification evidence, dependency review evidence, release-candidate signoff, external review readiness evidence, update/installer integrity, and the current not-complete audit verdict before any security-ready claim.
