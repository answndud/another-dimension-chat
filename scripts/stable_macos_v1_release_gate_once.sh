...
PUBLICATION_SCOPE_DOWN="reference/GITHUB_RELEASE_PUBLICATION_SCOPE_DOWN.md"

for file in "$GATE_DOC" "$HOLD_REPORT" "$CLAIM_GATE" "$PACKET" "$CLAIM_DECISION" "$PUBLICATION_SCOPE_DOWN" \
...
must_contain "$GATE_DOC" "stable_release_candidate_gate_decision=lower-release-class-only"
must_contain "$GATE_DOC" "next_release_class=signed-public-beta-or-rc"
must_contain "$GATE_DOC" "stable_macos_v1_release_allowed=false"
must_contain "$GATE_DOC" "public_stable_release_allowed=false"
must_contain "$GATE_DOC" "lower_release_publication_selected=true"
must_contain "$GATE_DOC" "stable_signed_notarized_artifact_available=false"
must_contain "$GATE_DOC" "d100_3_signed_notarized_execution_path_reviewed=true"
must_contain "$GATE_DOC" "macos_signed_notarized_execution_path_available=true"
must_contain "$GATE_DOC" "signed_notarized_rc_execution_ready=false"
...
must_contain "$GATE_DOC" "d100_1_e2ee_source_gate_reviewed=true"
must_contain "$GATE_DOC" "protocol_session_e2ee_source_ready=true"
must_contain "$GATE_DOC" "d100_2_key_management_source_gate_reviewed=true"
must_contain "$GATE_DOC" "production_key_management_source_ready=true"
...
must_contain "$GATE_DOC" "lower_release_class_claim_boundary_ready=true"
must_contain "$GATE_DOC" "public_wording_matches_lower_release_class=true"
...
must_contain "$GATE_DOC" "stable_release_published=false"
must_contain "$GATE_DOC" "stable_release_upload_authorized=false"
must_contain "$GATE_DOC" "release_body_edit_performed=false"
must_contain "$GATE_DOC" "release_asset_delete_performed=false"
must_contain "$GATE_DOC" "lower_release_publication_claim_boundary_ready=true"
...
must_contain "$PUBLICATION_SCOPE_DOWN" "lower_release_publication_selected=true"
must_contain "$PUBLICATION_SCOPE_DOWN" "stable_release_published=false"
...
must_contain "reference/PRODUCTION_PROTOCOL_SESSION_LIFECYCLE.md" "protocol_session_e2ee_source_ready=true"
must_contain "reference/PRODUCTION_KEY_STORAGE_LIFECYCLE.md" "production_key_management_ready=false"
must_contain "reference/PRODUCTION_KEY_STORAGE_LIFECYCLE.md" "production_key_management_source_ready=true"
