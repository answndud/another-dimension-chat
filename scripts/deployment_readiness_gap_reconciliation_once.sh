...
must_contain "$MATRIX" "windows_result_requires_valid_artifact_manifest=true"
must_contain "$MATRIX" "windows_artifact_package_structure_verified_by_validator=true"
