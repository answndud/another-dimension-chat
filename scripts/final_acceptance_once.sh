...
echo "independent_review_packet_source_ready=true" >&2
echo "independent_review_packet_public_safe=true" >&2
echo "external_review_waiting_for_stable_candidate_evidence=true" >&2
echo "stable_candidate_evidence_required_before_external_review=true" >&2
echo "external_review_not_local_source_progress_blocker=true" >&2
echo "external_review_complete=false" >&2
echo "external_review_claim_allowed=false" >&2
echo "stable_candidate_blocked_by_external_review_evidence=true" >&2
...
echo "real_windows_runtime_result_present=false" >&2
echo "windows_runtime_result_packet_required_for_public_artifact=true" >&2
echo "windows_manifest_checksum_provenance_separate_from_runtime_result=true" >&2
echo "windows_non_windows_runtime_result_promoted=false" >&2
echo "windows_local_or_fabricated_runtime_result_promoted=false" >&2
echo "windows_public_artifact_consistency_verified=false" >&2
echo "windows_artifact_release_upload_authorized=false" >&2
echo "android_public_app_candidate_source_ready=true" >&2
echo "android_release_package_smoke_ready=false" >&2
echo "android_real_device_smoke_passed=false" >&2
echo "android_release_signing_ready=false" >&2
echo "android_apk_aab_artifact_ready=false" >&2
echo "android_public_artifact_ready=false" >&2
echo "android_public_claim_allowed=false" >&2
echo "ios_public_app_candidate_source_ready=true" >&2
echo "ios_release_package_smoke_ready=false" >&2
echo "ios_real_device_smoke_passed=false" >&2
echo "ios_provisioning_ready=false" >&2
echo "ios_ipa_artifact_ready=false" >&2
echo "ios_testflight_distribution_ready=false" >&2
echo "ios_app_store_distribution_ready=false" >&2
echo "ios_public_artifact_ready=false" >&2
echo "ios_public_claim_allowed=false" >&2
echo "mobile_readiness_claimed=false" >&2
...
echo "high_risk_runtime_evidence_validator_ready=true" >&2
echo "high_risk_runtime_evidence_schema=reference/HIGH_RISK_RUNTIME_EVIDENCE_SCHEMA.md" >&2
echo "high_risk_runtime_evidence_validator=scripts/high_risk_runtime_evidence_validate_once.sh" >&2
echo "high_risk_runtime_evidence_present=false" >&2
echo "high_risk_runtime_evidence_accepted=false" >&2
echo "high_risk_runtime_evidence_claim_separated=true" >&2
...
echo "missing_stable_candidate_conditions=p0_p1_audit#source_acceptance#external_two_machine_evidence#macos_artifact#windows_artifact#android_artifact#ios_artifact#emergency_advisory#release_artifact_consistency" >&2
...
echo "audited_claim_allowed=false" >&2
echo "windows_public_artifact_claim_allowed=false" >&2
echo "windows_installer_claim_allowed=false" >&2
echo "windows_upload_claim_allowed=false" >&2
echo "windows_production_claim_allowed=false" >&2
echo "high_risk_public_claim_allowed=false" >&2
echo "high_risk_ready_claim_allowed=false" >&2
