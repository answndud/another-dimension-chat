...
echo "missing_stable_candidate_conditions=p0_p1_audit#source_acceptance#external_two_machine_evidence#macos_artifact#windows_artifact#android_artifact#emergency_advisory#release_artifact_consistency" >&2
