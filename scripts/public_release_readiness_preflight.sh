...
echo "windows_public_artifact_prerequisites=explicit-release-request#real-windows-runtime-smoke#packaging-review#installer-signing-decisions#checksum-provenance#upload-hold-review"
...
echo "next_development_axis=windows-packaging-hold-gate#release-packaging-upload-after-explicit-user-request#real-user-test-prep#default-transport-boundary"
echo "next=choose Windows packaging hold review, release packaging/upload only after explicit user request, real-user test preparation, or default transport boundary"
