...
check_macos_public_beta_final_sources() {
  ...
  require_text "$ROOT_DIR/reference/MACOS_FRESH_INSTALL_REHEARSAL_RESULT.md" "clean_machine_execution=false"
  ...
  require_text "$ROOT_DIR/reference/MACOS_FRESH_INSTALL_REHEARSAL_RESULT.md" "artifact_sha256=$EXPECTED_DMG_SHA"
  require_text "$ROOT_DIR/reference/MACOS_FRESH_INSTALL_REHEARSAL_RESULT.md" "release_download_source=github-release"
  require_text "$ROOT_DIR/reference/MACOS_FRESH_INSTALL_REHEARSAL_RESULT.md" "same_release_checksum_result=pass"
  require_text "$ROOT_DIR/reference/MACOS_FRESH_INSTALL_REHEARSAL_RESULT.md" "next_owner_action=run-clean-macos-fresh-install-with-disposable-profile"
