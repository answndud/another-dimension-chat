...
echo "checks=artifact-boundary,update-integrity-policy,desktop-beta-acceptance-matrix,desktop-public-beta-source-freeze,desktop-windows-readiness-source-audit,desktop-windows-local-runtime-smoke-boundary,desktop-real-user-test-prep,public-beta-gap,public-claim-acceptance"
echo "checks_run=artifact-boundary,update-integrity-policy,desktop-beta-acceptance-matrix,desktop-public-beta-source-freeze,desktop-windows-readiness-source-audit,desktop-windows-local-runtime-smoke-boundary,desktop-real-user-test-prep,public-beta-gap,public-claim-acceptance"
...
echo "source_freeze_next_axes=release-packaging-upload-after-explicit-user-request#windows-readiness#real-user-test-prep"
...
echo "desktop_beta_acceptance_matrix=invite#verify#send#receive#retry#cancel#import#delete#unlock#diagnostics#release-non-claim"
...
echo "next_development_axis=release-packaging-upload-after-explicit-user-request#windows-readiness#real-user-test-prep"
echo "next=choose release packaging/upload only after explicit user request, Windows readiness, or real-user test preparation"
