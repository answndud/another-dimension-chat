...
echo "checks=artifact-boundary,update-integrity-policy,desktop-beta-acceptance-matrix,public-beta-gap,public-claim-acceptance"
echo "checks_run=artifact-boundary,update-integrity-policy,desktop-beta-acceptance-matrix,public-beta-gap,public-claim-acceptance"
