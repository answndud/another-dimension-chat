...
must_contain "reference/FINAL_100_EVIDENCE_LEDGER_SCHEMA.md" "final_100_evidence_ledger_requires_valid_windows_artifact_manifest=true"
must_contain "reference/FINAL_100_EVIDENCE_LEDGER_SCHEMA.md" "final_100_evidence_ledger_requires_valid_windows_runtime_result=true"
