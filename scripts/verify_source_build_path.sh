...
require_text README.md "Install on macOS"
require_text README.md "unsigned DMG primary"
...
require_text README.ko.md "macOS 설치"
require_text README.ko.md "unsigned DMG primary"
...
require_file INSTALL_UNSIGNED_DMG_MACOS.md
require_text INSTALL_UNSIGNED_DMG_MACOS.md "shasum -a 256 -c SHA256SUMS.txt"
require_text INSTALL_UNSIGNED_DMG_MACOS.md "Open Anyway"
require_text INSTALL_UNSIGNED_DMG_MACOS.md "xattr"
...
require_text SUPPORT.md "Unsigned DMG Primary"
require_text SUPPORT.md "Source Build Alternate"
...
require_text .github/ISSUE_TEMPLATE/public_beta_support.yml "Unsigned DMG primary public beta support"
...
require_text apps/desktop-tauri/README.md "unsigned DMG primary"
require_text apps/desktop-tauri/README.md "source build alternate"
...
require_text .github/workflows/macos-unsigned-release.yml "Release tag:"
require_text .github/workflows/macos-unsigned-release.yml "Commit:"
require_text .github/workflows/macos-unsigned-release.yml "Runner: macos-14"
require_text .github/workflows/macos-unsigned-release.yml "Architecture: arm64"
