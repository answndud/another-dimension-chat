...
grep -q 'scripts/verify_release_signing_candidate_evidence_index_checksum_fixture_audit.sh' "$ROOT_DIR/RELEASE_COMPLETION_AUDIT.md"
grep -q 'scripts/verify_release_signing_candidate_signed_artifact_verification_requirements.sh' "$ROOT_DIR/RELEASE_COMPLETION_AUDIT.md"
grep -q 'scripts/verify_release_signing_candidate_signed_artifact_verification_fixture.sh' "$ROOT_DIR/RELEASE_COMPLETION_AUDIT.md"
grep -q 'scripts/verify_release_signing_candidate_signed_artifact_verification_fixture_audit.sh' "$ROOT_DIR/RELEASE_COMPLETION_AUDIT.md"
...
grep -q 'scripts/verify_release_signing_candidate_signed_artifact_verification_guard_audit.sh' "$ROOT_DIR/RELEASE_COMPLETION_AUDIT.md"
