...
for (let index = 0; index < args.length; index += 1) {
  ...
  else if (args[index] === "--review-bundle") reviewBundle = args[++index];
...
if (!reviewBundle || !reviewSignoff || !reviewerPublicKey) throw new Error("A review bundle, signed independent security review, and reviewer public key are required for the public release gate.");
