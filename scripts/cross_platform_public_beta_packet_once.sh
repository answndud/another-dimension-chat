...
require_output "$windows_manifest_output" "windows_artifact_engine_sidecar_packaged_verified=true"
require_output "$windows_manifest_output" "windows_artifact_engine_sidecar_manual_self_test_required=true"
...
require_output "$windows_runtime_output" "windows_result_engine_sidecar_diagnostics_verified=true"
require_output "$windows_runtime_output" "windows_result_engine_sidecar_manual_self_test_verified=true"
...
require_output "$windows_execution_output" "windows_result_engine_sidecar_diagnostics_verified=true"
require_output "$windows_execution_output" "windows_result_engine_sidecar_manual_self_test_verified=true"
