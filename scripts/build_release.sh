...
cp "$PROJECT_DIR/apps/server/server.mjs" "$PROJECT_DIR/apps/server/storage.mjs" "$PROJECT_DIR/apps/server/package.json" "$PROJECT_DIR/apps/server/README.md" "$STAGE/another-dimension-$VERSION/apps/server/"
