...
cp "$PROJECT_DIR/scripts/start_local_server.sh" "$PROJECT_DIR/scripts/install_local_server.sh" "$PROJECT_DIR/scripts/update_local_server.sh" "$PROJECT_DIR/scripts/verify_install_state.mjs" "$PROJECT_DIR/scripts/configure_local_server.mjs" "$PROJECT_DIR/scripts/preflight_local_server.mjs" "$PROJECT_DIR/scripts/generate_tls_cert.sh" "$PROJECT_DIR/scripts/check_https_endpoint.mjs" "$PROJECT_DIR/scripts/release_manifest.mjs" "$PROJECT_DIR/scripts/product_boundary.mjs" "$PROJECT_DIR/scripts/verify_release_manifest.mjs" "$PROJECT_DIR/scripts/verify_public_release_gate.mjs" "$PROJECT_DIR/scripts/verify_web_artifact.mjs" "$PROJECT_DIR/scripts/verify_support_matrix.mjs" "$PROJECT_DIR/scripts/verify_release_support_gate.mjs" "$PROJECT_DIR/scripts/verify_service_worker.mjs" "$PROJECT_DIR/scripts/verify_service_worker_runtime.mjs" "$STAGE/another-dimension-$VERSION/scripts/"
