...
require_text "$ROOT_DIR/apps/desktop-tauri/src/private-delivery-state.test.js" "allowed_public_intake_fields=app-version#build-channel#build-commit#platform#public-diagnostics#checksum-result#failure-class#recovery-next-action#desktop-acceptance-status#desktop-acceptance-blockers#app-launch-network"
require_text "$ROOT_DIR/apps/desktop-tauri/src/private-delivery-state.test.js" "forbidden_public_intake_fields=raw-logs#endpoints#invite-codes#message-text#local-paths#payloads#safety-phrases#profile-names#passphrases#key-material#private-planning-notes"
...
require_text "$ROOT_DIR/scripts/public_release_readiness_preflight.sh" "real_user_test_allowed_fields=app-version#build-channel#build-commit#platform#public-diagnostics#checksum-result#failure-class#recovery-next-action#desktop-acceptance-status#desktop-acceptance-blockers#app-launch-network"
