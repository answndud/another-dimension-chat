...
require_text "$ROOT_DIR/scripts/public_release_readiness_preflight.sh" "windows_artifact_type=windows-manual-e2ee-nsis-exe-installer-candidate"
require_text "$ROOT_DIR/scripts/public_release_readiness_preflight.sh" "windows_runtime_mode=manual-e2ee"
