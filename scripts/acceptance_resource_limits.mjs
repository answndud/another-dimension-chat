...
expect("session", /MAX_MESSAGE_BYTES: usize = 1024 \* 1024/, "MLS message limit changed without updating RESOURCE_LIMITS.json");
...
expect("controller", /maxLength = 90000/, "browser message input has no bounded length");
