...
check_release_integrity_policy() {
  require_text "$ROOT_DIR/README.md" "The current public unsigned packet is attached to this GitHub Release tag"
  ...
  require_text "$ROOT_DIR/reference/MACOS_UNSIGNED_OSS_PUBLIC_RELEASE_PACKET.md" "Do not use terminal quarantine-removal commands"
