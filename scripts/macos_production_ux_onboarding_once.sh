...
must_contain "$DOC" "next_required_phase=OPS-6 macOS production distribution"
...
must_contain "reference/PRODUCTION_READINESS_CLAIM_GATE.md" "next_required_phase=OPS-6 macOS production distribution"
