...
must_contain "$DOC" "independent_review_packet_source_ready=true"
must_contain "$DOC" "independent_review_packet_public_safe=true"
must_contain "$DOC" "independent_review_packet_waits_for_stable_candidate_evidence=true"
must_contain "$DOC" "stable_candidate_evidence_required_before_external_review=true"
must_contain "$DOC" "external_review_not_local_source_progress_blocker=true"
...
must_contain "reference/PRODUCTION_READINESS_CLAIM_GATE.md" "independent_review_packet_source_ready=true"
must_contain "reference/PRODUCTION_READINESS_CLAIM_GATE.md" "independent_review_packet_public_safe=true"
must_contain "reference/PRODUCTION_READINESS_CLAIM_GATE.md" "independent_review_packet_waits_for_stable_candidate_evidence=true"
must_contain "reference/PRODUCTION_READINESS_CLAIM_GATE.md" "stable_candidate_evidence_required_before_external_review=true"
must_contain "reference/PRODUCTION_READINESS_CLAIM_GATE.md" "external_review_not_local_source_progress_blocker=true"
