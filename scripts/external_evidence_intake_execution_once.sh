...
must_contain "$FIELD_PROGRAM" "f100_1_field_evidence_blocker_closed=true"
must_contain "$FIELD_PROGRAM" "field_evidence_policy_waiver_authorized=true"
must_contain "$FIELD_PROGRAM" "field_evidence_execution_claim_allowed=false"
