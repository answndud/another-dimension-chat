...
require_text "$DOC" "next_required_phase=Phase A100-1 - External Security Review Packet Freeze"
...
printf 'next_required_phase=Phase-A100-1-External-Security-Review-Packet-Freeze\n'
