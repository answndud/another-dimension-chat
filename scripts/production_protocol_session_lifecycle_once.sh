...
require_text "$DOC" "next_required_phase=Phase C100-5 - Advanced Onion/Tor Evidence Boundary"
...
printf 'next_required_phase=Phase-C100-5-Advanced-Onion-Tor-Evidence-Boundary\n'
