...
grep -q 'Release signing | No signing workflow or signed artifact verification exists; a pre-implementation signing plan and dry-run verification fixture exist' \
