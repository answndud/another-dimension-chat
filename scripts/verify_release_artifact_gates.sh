...
grep -q 'Release signing | No release signing workflow or signed artifact verification exists; a pre-implementation signing plan, tooling decision, dry-run verifier, and disposable detached-signature fixture exist' \
