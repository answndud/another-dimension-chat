...
const checks = [
  ...
  ["README.md", "## 릴리스 설치"],
  ["README.md", "verify_private_release_gate.mjs"],
  ["reference/INCIDENT_RESPONSE.md", "## 암호문구 노출"],
  ["reference/INCIDENT_RESPONSE.md", "## recovery 파일 노출"],
  ["reference/INCIDENT_RESPONSE.md", "## 악성 업데이트 의심"],
  ["reference/INCIDENT_RESPONSE.md", "## 상대방 device 폐기"],
  ["reference/INCIDENT_RESPONSE.md", "## relay 데이터 손상"],
