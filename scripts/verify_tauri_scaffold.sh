...
require_contains "$APP_DIR/src/main.js" 'prepareInviteRoomLocalSetup'
require_contains "$APP_DIR/src/main.js" 'usePeerInviteSetupCode'
require_contains "$APP_DIR/src/main.js" 'saveInviteSessionDraftAfterSafetyConfirm'
require_contains "$APP_DIR/src/main.js" 'usePeerInviteSessionCode'
...
require_contains "$APP_DIR/index.html" 'local-invite-setup-code'
require_contains "$APP_DIR/index.html" 'peer-invite-session-code'
require_contains "$APP_DIR/index.html" 'private-route-exchange'
require_contains "$APP_DIR/src/main.js" 'Check recovered room before preparing this device again'
...
require_contains "$APP_DIR/src/i18n.test.js" 'all UI translation keys used by the app exist in every supported language'
...
require_contains "$APP_DIR/src/styles.css" 'body\.is-developer-mode \.system-settings-panel\[open\] > \.boundary-details'
...
require_contains "$APP_DIR/index.html" '<details class="room-secondary-options">'
...
require_contains "$APP_DIR/src/action-state.test.js" 'productionInviteCodeProfiles derives opposite roles'
require_contains "$APP_DIR/src/action-state.test.js" 'productionTwoProfilePairFromProfiles preserves invite-code rooms'
...
require_contains "$APP_DIR/index.html" 'copy-pending-invite-code'
require_contains "$APP_DIR/index.html" 'reject-two-profile-safety'
require_contains "$APP_DIR/index.html" 'close-chat-settings'
...
require_contains "$APP_DIR/src/i18n.js" '이 기기에서 시작'
require_contains "$APP_DIR/src/i18n.js" '문구가 다르면 이 채팅방을 사용하지 마세요'
require_contains "$APP_DIR/src/i18n.js" 'roomStatusShortReady: "대화 가능"'
...
require_contains "$APP_DIR/src/action-state.test.js" 'ProfileABootstrapTimeout'
...
require_contains "$APP_DIR/src/main.js" 'hasConversation || latestProductionTwoProfileSuccess || sessionsReady'
...
require_contains "$APP_DIR/src/styles.css" 'body.has-ready-session.needs-safety-confirmation #production-two-profile-transcript'
