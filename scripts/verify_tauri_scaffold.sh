...
require_contains "$APP_DIR/src/production-profile-controller.js" 'invoke("production_profile_unlock"'
...
require_contains "$APP_DIR/src/transcript-controller.js" 'Resume needs session check'
